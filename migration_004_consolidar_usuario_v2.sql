...
ALTER SEQUENCE usuarios.usuario_id_seq RENAME TO usuario_legacy_id_seq;
ALTER SEQUENCE usuarios.usuario_papel_id_seq RENAME TO usuario_papel_legacy_id_seq;
...
ALTER SEQUENCE usuarios.conta_usuario_id_seq RENAME TO usuario_id_seq;
...
ALTER INDEX usuarios.idx_conta_usuario_email_verificado RENAME TO idx_usuario_email_verificado;
...
CREATE TABLE usuarios.usuario_papel (
    ...
    papel_id INTEGER NOT NULL REFERENCES usuarios.papel(id) ON DELETE CASCADE,
